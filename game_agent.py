    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        def max_val(game, depth):
            ...
            # As it is a maximizer, the initial score is to -inf
            overall_score = float('-inf')

            legal_moves = game.get_legal_moves()
            for move in legal_moves:
                node_games = game.forecast_move(move)
                score = min_val(node_games, depth - 1)
        ...
        def min_val(game, depth):
            ...
            # As it is a minimizer, the initial score is to +inf
            overall_score = float('inf')

            legal_moves = game.get_legal_moves()
            for move in legal_moves:
                node_games = game.forecast_move(move)
                score = max_val(node_games, depth - 1)
                if score < overall_score:
                    overall_score = score
        ...
        # Top Node is always a maximizer --> initial score -inf
        main_score = float('-inf')
        # In case of no available move
        best_move = (-1, -1)
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        def max_val(game, depth, alpha, beta):
            ...
            for move in legal_moves:
                node_games = game.forecast_move(move)
                score = min_val(node_games, depth - 1, alpha, beta)
                if score > overall_score:
                    overall_score = score

                if overall_score >= beta:
                    return overall_score

                alpha = max(overall_score, alpha)
        ...
        def min_val(game, depth, alpha, beta):
            ...
            for move in legal_moves:
                node_games = game.forecast_move(move)
                score = max_val(node_games, depth - 1, alpha, beta)
                if score < overall_score:
                    overall_score = score

                if overall_score <= alpha:
                    return overall_score

                beta = min(overall_score, beta)
        ...
        for move in legal_moves:
            node_games = game.forecast_move(move)
            score = min_val(node_games, depth - 1, overall_score, beta)
            if score > overall_score:
                best_action = move
                overall_score = score
